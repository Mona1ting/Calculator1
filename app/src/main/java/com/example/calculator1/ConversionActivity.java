...
public class ConversionActivity<buttons>  extends AppCompatActivity implements View.OnClickListener{
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        switch(id){
            case R.id.action_calculator:
                item.setIntent(new Intent(ConversionActivity.this,MainActivity.class));
                break;
            case R.id.action_conversion:
                break;
            case R.id.action_exchangerate:
                item.setIntent(new Intent(ConversionActivity.this,ExchangerateActivity.class));
                break;
        }
      ...
      //  Toast.makeText(this, spin, Toast.LENGTH_SHORT).show();
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener(){
            protected void onItemSelectedListener(AdapterView<?> adapterView, View view, int i, long l){
                if(i>0)
                    Toast.makeText(ConversionActivity.this,adapterView.getItemAtPosition(i).toString(), Toast.LENGTH_SHORT).show();
            }
            @Override
